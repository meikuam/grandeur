...
from src.model.squeezeformer.attention import MultiHeadedSelfAttentionModule
from src.model.squeezeformer.modules import (
    ResidualConnectionModule,
    FeedForwardModule,
    recover_resolution,
)
from src.model.squeezeformer.convolution import (
    ConvModule,
